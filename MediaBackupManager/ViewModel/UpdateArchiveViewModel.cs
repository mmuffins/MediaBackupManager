...
{
    public class UpdateArchiveViewModel : ViewModelBase
    {
        ...
        ArchiveViewModel updateArchive;
            ...
            get
            {
                if (startCommand == null)
                {
                    startCommand = new RelayCommand(
                        async p => await UpdateArchive(UpdateSet),
                        p => true);
                }
                return startCommand;
            }
        ...
        /// <summary>
        /// Gets or sets Archive that is being updated.</summary>  
        public ArchiveViewModel UpdateSet
        {
            get { return updateArchive; }
            set
            {
                if (value != updateArchive)
                {
                    updateArchive = value;
                    NotifyPropertyChanged();
                }
        ...
        public UpdateArchiveViewModel(FileIndexViewModel index, ArchiveViewModel archive)
        {
            this.index = index;
            ...
            this.UpdateSet = archive;
            this.Title = "Updating Archive " + archive.Label;
        ...
        /// <summary>
        /// Updates the provided Archive.</summary>  
        private async Task UpdateArchive(ArchiveViewModel archive)
        {
            ...
            directoryScan = index.UpdateArchiveAsync(archive, TokenSource.Token, scanProgress, statusText);
            await directoryScan;
